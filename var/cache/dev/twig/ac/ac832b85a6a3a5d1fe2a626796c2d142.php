    ...
    <div class=\"main-page\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["dwellings"]) {
            ...
            echo "</div>
                            <div>";
            // line 33
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["dwellings"], 2, [], "array", false, false, false, 33), "real_name", [], "any", false, false, false, 33), "html", null, true);
            echo " (";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["dwellings"], 2, [], "array", false, false, false, 33), "code", [], "any", false, false, false, 33), "html", null, true);
            echo ") - ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["dwellings"], 2, [], "array", false, false, false, 33), "nom", [], "any", false, false, false, 33), "html", null, true);
            echo "</div>
...
{% include 'inc/parts/footer.html.twig' %}", "inc/pages/category/index.html.twig", "/Users/nathandfk/Development/Symfony/atypikhouse/templates/inc/pages/category/index.html.twig");
    }
}
