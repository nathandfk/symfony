...
return [
    ...
    [ // $dynamicRoutes
        ...
        359 => [[['_route' => 'checkout_success', '_controller' => 'App\\Controller\\CheckoutController::habitation'], ['id'], null, null, false, true, null]],
        438 => [[['_route' => 'app_checkout_paiement', '_controller' => 'App\\Controller\\ProductController::paiement'], ['id', 'arrival', 'departure', 'adults', 'childrens', 'babies', 'animals'], null, null, false, true, null]],
        473 => [[['_route' => 'edit_dwelling', '_controller' => 'App\\Controller\\EditDwellingController::editDwelling'], ['id'], null, null, false, true, null]],
        510 => [
